...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeMaterial3LibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.compose.material3.adaptive</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>appVersionCode</b> with value <b>22</b>
         * <p>
         ...
         */
        public Provider<String> getAppVersionCode() { return getVersion("appVersionCode"); }

        /**
         * Version alias <b>appVersionName</b> with value <b>22</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAppVersionName() { return getVersion("appVersionName"); }
        ...
        /**
         * Version alias <b>kover</b> with value <b>0.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktor</b> with value <b>3.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.gradle</b> with value <b>8.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>android.minSdk</b> with value <b>23</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxComposeMaterial3VersionAccessors vaccForAndroidxComposeMaterial3VersionAccessors = new AndroidxComposeMaterial3VersionAccessors(providers, config);
        public AndroidxComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.androidx.compose.material3</b>
         */
        public AndroidxComposeMaterial3VersionAccessors getMaterial3() {
            return vaccForAndroidxComposeMaterial3VersionAccessors;
        }

    }

    public static class AndroidxComposeMaterial3VersionAccessors extends VersionFactory  {

        public AndroidxComposeMaterial3VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.compose.material3.adaptive</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAdaptive() { return getVersion("androidx.compose.material3.adaptive"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>android.gradle</b>
         * <p>
