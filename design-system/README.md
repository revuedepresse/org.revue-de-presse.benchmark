...
> **M1 status:** foundation tokens + 11 atoms compiled to React and Vue. M2 (molecules + 3 more generators), M3 (organisms + auth with OWASP password rules), M4 (remaining 5 generators), and M5 (publish v1.0.0) are tracked in (internal design notes).
...
- (internal design notes) — full spec.
- (internal design notes) — M1 through M5 implementation plans.
