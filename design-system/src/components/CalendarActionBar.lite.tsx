...
export default function CalendarActionBar(props: CalendarActionBarProps) {
  return (
    <div
      class={`rdp-calendar-action-bar rdp-calendar-action-bar--${props.position ?? 'top'}`}
    >
      <button
        type="button"
        class="rdp-calendar-action-bar__pill"
        aria-label={t('actions.pick-month.aria-label', undefined, props.locale ?? 'fr-FR')}
        onClick={() => props.onPillClick?.()}
      >
        <Icon name="pick-day" size={16} decorative={true} />
      ...
      <div class="rdp-calendar-action-bar__nav">
        ...
        >
          <Icon name="previous-item" size={32} decorative={true} />
        </button>
        <button
          type="button"
        ...
        >
          <Icon name="next-item" size={32} decorative={true} />
        </button>
      </div>
      <style>{`
