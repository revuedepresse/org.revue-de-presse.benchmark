...
// "Pinned" intro tile that opens the publication list, mirroring the legacy
// status card on production but in the dark Outro/BannerAbout palette.
    ...
    <article class="rdp-intro-card">
      <header class="rdp-intro-card__header">
        <span class="rdp-intro-card__avatar" aria-hidden="true">
          <Logo size="md" showWordmark={false} altKey="logo.alt" />
        </span>
