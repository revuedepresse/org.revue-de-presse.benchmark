  ...
  return (
    <article className="rdp-legal-notice">
      ...
      <p>
        ...
        {(props.tiktokAccount ?? "revue_2_presse").replace(/^@/, "")}, une vidéo
      ...
      <ul>
        <li>
          ...
          affiché et image d'avatar du compte officiel, utilisés uniquement pour
          confirmer que le jeton d'accès correspond bien au compte
          attendu&nbsp;;
        </li>
        <li>
      ...
      <p>
        ...
        profilage. Les jetons d'accès et de rafraîchissement délivrés par TikTok
        sont conservés de manière chiffrée sur l'infrastructure de publication,
        sont renouvelés à chaque exécution conformément aux recommandations de
        TikTok, et peuvent être révoqués à tout moment par l'Éditeur depuis sa
      ...
      <style>{`         .rdp-legal-notice {           background: var(--color-white);           border-radius: var(--radius-default);           padding: var(--separation-3);           font-family: "Roboto", sans-serif;           color: var(--color-content-text);         }         .rdp-legal-notice h1 {           font-family: "Signika", sans-serif;           color: var(--color-brand);           margin: 0 0 var(--separation-2);         }         .rdp-legal-notice h2 {           font-family: "Signika", sans-serif;           color: var(--color-brand);           font-size: var(--font-size-status-text);           margin: var(--separation-2) 0 var(--separation-1);         }         .rdp-legal-notice p {           margin: 0 0 var(--separation-2);           line-height: var(--line-height-base);         }         .rdp-legal-notice ul {           margin: 0 0 var(--separation-2);           padding-left: var(--separation-3);           line-height: var(--line-height-base);         }         .rdp-legal-notice li {           margin: 0 0 var(--separation-1);         }         .rdp-legal-notice a {           color: var(--color-brand);           text-decoration: underline;         }       `}</style>
    </article>
  );
}
