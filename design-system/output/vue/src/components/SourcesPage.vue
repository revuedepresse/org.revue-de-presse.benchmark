<template>
  <article class="rdp-sources-page">
    ...
    <p>
      Les sources des brèves de publications<a
    ...
    <ul class="rdp-sources-page__list" role="list">
      <template :key="index" v-for="(row, index) in sortedRoster">
        <li class="rdp-sources-page__item">
          <a
            ...
            /><span class="rdp-sources-page__meta"
              ...
              ><span class="rdp-sources-page__handle"
                >@{{ row.handle }}</span
              ></span
            ></a
          >
...
const ROSTER: SourceRow[] = [
  ...
  {
    handle: "blast-info.fr",
    displayName: "Blast le souffle de l’info",
    avatar:
  ...
  {
    handle: "challengesfr.bsky.social",
  ...
  {
    handle: "franceculture.fr",
    displayName: "France Culture",
    avatar:
  ...
  {
    handle: "lavoixdunord.fr",
    displayName: "La Voix du Nord",
    avatar:
  ...
  {
    handle: "lecanardenchaine.fr",
    displayName: "Le Canard enchaîné",
    avatar:
  ...
  {
    handle: "afrique.lemonde.fr",
    displayName: "Le Monde Afrique",
    avatar:
  ...
  {
    handle: "pixelsfr.bsky.social",
    displayName: "Pixels | Le Monde",
    avatar:
  ...
  {
    handle: "telerama.bsky.social",
    displayName: "Télérama",
    avatar:
