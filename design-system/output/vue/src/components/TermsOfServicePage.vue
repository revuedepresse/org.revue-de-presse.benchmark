<template>
  <article class="rdp-terms-of-service">
    ...
    <p>
      ...
      complémentaires&nbsp;: archivage par date, consultation des sources, et un
      assistant de discussion en langage naturel. L'ensemble des contenus est
      publié à titre d'information et sans valeur contractuelle.
    </p>
