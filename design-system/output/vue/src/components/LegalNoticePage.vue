<template>
  <article class="rdp-legal-notice">
    ...
    <p>En vigueur au {{ effectiveAt ?? "09/05/25" }}</p>
    <p>
      ...
      {{ site ?? "revue-de-presse.org" }}, ci-après le «&nbsp;Site&nbsp;», les
    ...
    <p>
      L'édition et la direction de la publication du Site sont assurées par{{
        editor ?? "Thierry Marianne"
      }}, dont l'adresse e-mail est{{ email ?? "contact@revue-de-presse.org" }},
      ci-après l'«&nbsp;Éditeur&nbsp;».
    </p>
    <h2>ARTICLE 2 – HÉBERGEURS</h2>
    <p>
      Les hébergeurs du Site sont la société Scaleway (8 rue de la Ville
      l'Évêque, 75008 Paris, +33 (0)1 84 13 00 00) ainsi que la société Netlify
      (44 Montgomery Street, Suite 300, San Francisco, California 94104), dont
    ...
    <p>
      ...
      la revue de presse archivée. L'accès au service est réservé aux personnes
      ayant un compte Bluesky actif. La connexion est réalisée via le protocole
      OAuth de l'AT&nbsp;Protocol et ne donne au Site accès qu'à l'identifiant
      décentralisé (DID) du compte&nbsp;; aucun mot de passe n'est transmis au
      Site.
    </p>
    <p>
      L'Utilisateur s'engage à utiliser l'Assistant de bonne foi, à des fins
      d'information personnelle. Sont notamment interdits&nbsp;: les tentatives
      de contournement des quotas d'usage, l'envoi automatisé de requêtes, la
    ...
    <p>
      ...
      renvoyant à la publication source d'origine&nbsp;; l'Utilisateur est
      invité à consulter ces sources avant toute reprise.
    </p>
    ...
    <p>
      ...
      transmise à ces prestataires&nbsp;: seul le contenu de la question et les
      extraits de presse pertinents sont envoyés.
    </p>
    <p>
