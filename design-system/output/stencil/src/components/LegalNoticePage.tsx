  ...
  render() {
    return (
      <article class="rdp-legal-notice">
        ...
        <p>
          L'Éditeur opère, pour son propre compte, une application déclarée
          auprès de TikTok afin de publier chaque jour, sur le compte officiel @
          {(this.tiktokAccount ?? "revue_2_presse").replace(/^@/, "")}, une
        ...
        <ul>
          ...
          <li>
            ...
            &nbsp;: dépôt de la vidéo quotidienne en tant que brouillon dans la
            boîte de réception du compte officiel, en vue d'une finalisation
            manuelle ou d'une publication directe&nbsp;;
          </li>
          <li>
            <strong>video.list</strong>
            &nbsp;: lecture de la liste des vidéos publiques du compte officiel,
            à seule fin de vérifier qu'une publication quotidienne a bien abouti
