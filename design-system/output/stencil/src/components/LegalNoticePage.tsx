  ...
  render() {
    return (
      <article class="rdp-legal-notice">
        ...
        <h2 id="cgu">
          ARTICLE 5 – CONDITIONS GÉNÉRALES D'UTILISATION DU SERVICE DE
          DISCUSSION
        </h2>
        <p>
          Le Site propose un service de discussion (l'«&nbsp;Assistant&nbsp;»)
          permettant à l'Utilisateur de poser des questions en langage naturel
          sur la revue de presse archivée. L'accès au service est réservé aux
          personnes ayant un compte Bluesky actif. La connexion est réalisée via
          le protocole OAuth de l'AT&nbsp;Protocol et ne donne au Site accès
          qu'à l'identifiant décentralisé (DID) du compte&nbsp;; aucun mot de
          passe n'est transmis au Site.
        </p>
        <p>
          ...
          requêtes, la sollicitation de contenus illicites, diffamatoires,
          haineux ou portant atteinte aux droits de tiers. L'Éditeur se réserve
          le droit de suspendre l'accès en cas d'usage manifestement abusif,
          sans préavis.
        </p>
        <p>
          Les réponses de l'Assistant sont générées par un modèle de langage et
          peuvent comporter des erreurs ou des omissions. Elles ne constituent
          ni un avis journalistique ni un conseil professionnel et ne sauraient
          engager la responsabilité de l'Éditeur. Chaque affirmation est citée
          par un numéro renvoyant à la publication source d'origine&nbsp;;
        ...
        <ul>
          <li>
            son identifiant décentralisé Bluesky (DID) et, à titre indicatif,
            son handle public, conservés pour la durée de la session
            (30&nbsp;jours maximum)&nbsp;;
          </li>
          <li>
          ...
          <li>
            des compteurs techniques d'usage (nombre de requêtes par heure et
            par jour) servant à appliquer les quotas et à prévenir l'abus.
          </li>
        </ul>
        <p>
          ...
          sous-traitant principal, et, en cas d'indisponibilité, à
          Google&nbsp;LLC (Gemini&nbsp;API) en tant que sous-traitant
          secondaire. Aucune donnée d'identification personnelle (DID, handle,
          adresse&nbsp;IP) n'est transmise à ces prestataires&nbsp;: seul le
          contenu de la question et les extraits de presse pertinents sont
          envoyés.
        </p>
        <p>
          Conformément au Règlement (UE) 2016/679 («&nbsp;RGPD&nbsp;») et à la
          loi Informatique et Libertés modifiée, l'Utilisateur dispose d'un
          droit d'accès, de rectification, d'effacement, de limitation et de
          portabilité de ses données. Pour l'exercer, il suffit d'écrire à
          ...
          «&nbsp;Déconnexion&nbsp;» accessible depuis la page de discussion.
          Aucun cookie publicitaire ni traqueur tiers n'est déposé. Les seuls
          témoins de connexion utilisés sont techniques (cookie de session
          opaque, durée 30&nbsp;jours, HTTP-only).
        </p>
        <style>{`
        .rdp-legal-notice {
