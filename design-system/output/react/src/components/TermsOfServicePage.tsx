  ...
  return (
    <article className="rdp-terms-of-service">
      ...
      <p>
        ...
        modèle peut, comme tout LLM, produire des inexactitudes&nbsp;; le texte
        généré est publié à titre indicatif et ne saurait engager l'Éditeur. Les
        liens vers les comptes Bluesky cités dans la synthèse sont restreints à
        une liste d'éditeurs de presse vérifiés afin d'éviter toute redirection
        erronée.{" "}
      </p>
