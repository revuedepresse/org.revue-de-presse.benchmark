      ...
      <article class="rdp-terms-of-service">
        ...
        <ul>
          <li>
            ...
            uniquement à confirmer que l'autorisation a bien été délivrée pour
            le compte attendu. Elles ne sont ni revendues, ni rapprochées
            d'autres jeux de données.
          </li>
          <li>
            <strong>video.upload</strong> (Content Posting API)&nbsp;: dépôt de
            la vidéo quotidienne en tant que brouillon dans la boîte de
            réception du compte officiel pour validation manuelle, ou
            publication directe lorsque l'application est habilitée.
          </li>
          <li>
            <strong>video.list</strong> (Content Posting API)&nbsp;: lecture de
            la liste des vidéos publiques du compte officiel afin de vérifier le
            bon déroulement des publications quotidiennes et d'éviter les
            doublons.
          </li>
        </ul>
        <p>
