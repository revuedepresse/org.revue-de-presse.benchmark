...
export default class SupportPage extends LitElement {
  createRenderRoot() {
    return this;
  }
  ...
  render() {
    return html`
          ...
          <p>
            Revue de presse s'appuie sur l'API de Bluesky et relaie des brèves de presse
            en provenance exclusive de médias Français d'après le succès rencontré par
            ses brèves auprès du public.
          </p>
          <p>
            En effet, un classement s'appuyant sur les partages, offre chaque jour une
            visibilité sur 10 publications médias.
          </p>
          <p>
            L'intégralité du code source du projet est proposée sous licence libre (GNU
            General Public License v3.0) et est hébergée par l'organisation « Revue de
            Presse » :
          ...
          <ul>
            ...
            <li>
              partagez les publications et la mission du projet sur les réseaux sociaux
            </li>
            <li>
