...
export default class TermsOfServicePage extends LitElement {
  createRenderRoot() {
    return this;
  }
  ...
  render() {
    return html`
      ...
      this.email ?? "contact@revue-de-presse.org"
        ...
        <a  href="https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3"  rel="noreferrer noopener"  target="_blank" ><strong >Mistral 7B Instruct v0.3</strong></a>
        ...
        <ul ><li >
                  Bluesky&nbsp;:
        <a  href="https://bsky.app/profile/revue-de-presse.org"  rel="noreferrer nofollow noopener"  target="_blank" >
                    @revue-de-presse.org
                  </a>
        ...
        <li >
                  TikTok&nbsp;:
        <a  rel="noreferrer nofollow noopener"  target="_blank"  .href=${`https://www.tiktok.com/@${(
          this.tiktokAccount ?? "revue_2_presse"
        ).replace(/^@/, "")}`} >
                    @
        ${(this.tiktokAccount ?? "revue_2_presse").replace(/^@/, "")}</a>
        ...
        <a  href="https://developers.tiktok.com/"  rel="noreferrer nofollow noopener"  target="_blank" >
        ...
        <ul ><li ><strong >user.info.basic</strong>
         (Login Kit)&nbsp;: lecture des
        ...
        <li ><strong >video.upload</strong>
         (Content Posting API)&nbsp;: dépôt de la
        ...
        <li ><strong >video.list</strong>
         (Content Posting API)&nbsp;: lecture de la
