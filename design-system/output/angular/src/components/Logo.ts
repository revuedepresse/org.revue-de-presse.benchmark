...
export default class Logo {
  ...
  @Input() size!: LogoProps["size"];
  @Input() altKey!: LogoProps["altKey"];
  @Input() showWordmark!: LogoProps["showWordmark"];
}
