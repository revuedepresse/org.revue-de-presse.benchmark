  ...
  template: `
    <article class="rdp-legal-notice">
      ...
      <p>
        ...
        {{editor ?? 'Thierry Marianne'}} , dont l'adresse e-mail est
        {{email ??
      ...
      <p>
        ...
        {{(tiktokAccount ?? 'revue_2_presse').replace(/^@/, '')}} , une vidéo
...
export default class LegalNoticePage {
  @Input() effectiveAt!: LegalNoticePageProps["effectiveAt"];
  @Input() site!: LegalNoticePageProps["site"];
  @Input() editor!: LegalNoticePageProps["editor"];
  @Input() email!: LegalNoticePageProps["email"];
  @Input() tiktokAccount!: LegalNoticePageProps["tiktokAccount"];
}

@NgModule({
  declarations: [LegalNoticePage],
  imports: [CommonModule],
  exports: [LegalNoticePage],
})
